...
// bike reservation form -> opens a pre-filled email (works with no backend).
// To capture submissions in an inbox instead, swap the form for a Formspree
// action (see the comment in rentals.html) and remove this handler.
(function(){
  ...
  form.addEventListener('submit', function(e){
    ...
    var body=[
      ...
      'Email: '+g('r_email'),
      'Phone: '+g('r_phone'),
      'Preferred date: '+g('r_date'),
      'Duration: '+g('r_duration'),
      'Number of bikes: '+g('r_qty'),
      'Bike type: '+g('r_type'),
      '',
      'Notes: '+g('r_notes')
    ].join('\n');
    window.location.href='mailto:tracy@outsideincohasset.com'
      +'?subject='+encodeURIComponent('Bike Rental Reservation Request')
